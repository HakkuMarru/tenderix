...
export default function Hero() {
  return (
    <div className="relative h-screen flex items-center justify-center pt-[60px] xl:pt-[90px]">
      <div className="flex items-center justify-center flex-col gap-2 xl:gap-5 z-10">
        ...
        <div data-aos="fade-up" className="text-[#C6BFFF] px-[100px] text-md xl:text-xl text-center font-semibold">
