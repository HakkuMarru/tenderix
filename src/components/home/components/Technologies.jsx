...
export default function Technologies() {
  return (
    <div data-aos="fade-up" className="h-full xl:h-[80vh] flex flex-col gap-14 justify-center items-center mb-40 xl:mb-0 md:px-[100px] xl:py-[80px] xl:px-[200px] mx-14 lg:mx-0">
